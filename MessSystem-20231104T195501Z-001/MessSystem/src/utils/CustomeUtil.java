...
public interface CustomeUtil {
	 ...
	 public static void populateCustomer() {
		 map.put("gopal@sangwe",new Customer("gopal","sangwe","gopal@sangwe",
				 "gopu","latur","7894234224",LocalDate.now(),LocalDate.now().plusMonths(1),
				 Plan.MONTHLY,3000));
		 map.put("rohit@bhuyar",new Customer("rohit","bhuyar","rohit@bhuyar",
				 "rohu","akurdi","8894234224",LocalDate.of(2023,11,7),LocalDate.of(2023,11,7).plusMonths(6),
				 Plan.YEARLY,32000));
		 map.put("vishwa@bhuyar",new Customer("rohit","bhuyar","vishwa@bhuyar",
				 "piu","akurdi","8894234224",LocalDate.of(2023,01,5),LocalDate.of(2023,01,5).plusMonths(3),
